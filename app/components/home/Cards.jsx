...
const Cards = ({ trackerNumber, trackerId, driverName, temperature, humidity, status }) => {
  return (
    <div className="h-[100%] sm:h-[153px] p-6 bg-white rounded-lg shadow border border-[#e3e3e3] grid grid-cols-2">
      <div>
